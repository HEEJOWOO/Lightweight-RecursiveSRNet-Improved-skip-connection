...
class RDCAB(nn.Module):
    ...
    def forward(self, x, sfe_residual): 
        ...
        SB_layer_1 = self.SB_layer_1(x)+x
        ...
        SB_layer_2 = self.SB_layer_2(torch.cat((x, ID_concat_1), 1))+ID_concat_1
        ...
        SB_layer_3 = self.SB_layer_3(torch.cat((x, ID_concat_1,ID_concat_2), 1))+ID_concat_2
        ...
        SB_layer_4 = self.SB_layer_4(torch.cat((x, ID_concat_1,ID_concat_2,ID_concat_3), 1))+ID_concat_3
        ...
        SB_layer_5 = self.SB_layer_5(torch.cat((x, ID_concat_1,ID_concat_2,ID_concat_3,ID_concat_4), 1))+ID_concat_4
        ...
        SB_layer_6 = self.SB_layer_6(torch.cat((x, ID_concat_1,ID_concat_2,ID_concat_3,ID_concat_4,ID_concat_5), 1))+ID_concat_5
        ...
        SB_layer_7 = self.SB_layer_7(torch.cat((x, ID_concat_1,ID_concat_2,ID_concat_3,ID_concat_4,ID_concat_5,ID_concat_6), 1))+ID_concat_6
        ...
        SB_layer_8 = self.SB_layer_8(torch.cat((x, ID_concat_1,ID_concat_2,ID_concat_3,ID_concat_4,ID_concat_5,ID_concat_6,ID_concat_7), 1))+ID_concat_7
